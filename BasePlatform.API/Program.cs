...
using BasePlatform.API.Inventories.Application.Internal.CommandServices;
using BasePlatform.API.Inventories.Application.Internal.QueryServices;
using BasePlatform.API.Inventories.Domain.Repositories;
using BasePlatform.API.Inventories.Domain.Services;
using BasePlatform.API.Inventories.Infrastructure.Persistence.EFC.Repositories;
